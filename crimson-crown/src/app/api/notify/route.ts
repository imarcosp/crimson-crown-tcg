        ...
        <div style="font-family: sans-serif; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #e2e8f0; border-radius: 8px; overflow: hidden;">
          ...
          <div style="padding: 30px; background-color: #ffffff;">
            ...
            <div style="text-align: center; margin: 30px 0;">
              <a href="${link}" style="background-color: #E91E63; color: white; padding: 12px 25px; text-decoration: none; border-radius: 6px; font-weight: bold; font-size: 16px;">Ver Mi Pedido</a>
            </div>
      ...
      htmlContent = `
        <div style="font-family: sans-serif; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #e2e8f0; border-radius: 8px; overflow: hidden;">
          ...
          <div style="padding: 30px; background-color: #ffffff;">
            ...
            <div style="background-color: #f1f5f9; padding: 15px; border-left: 4px solid #E91E63; margin: 20px 0;">
                <h2 style="color: #E91E63; text-transform: uppercase; margin: 0;">${newStatus}</h2>
            </div>
            <div style="text-align: center; margin: 30px 0;">
