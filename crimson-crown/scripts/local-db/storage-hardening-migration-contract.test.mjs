...
const policyNames = Object.freeze([
  ...
  'Give users authenticated access to folder 1ifhysk_0',
  'Give users authenticated access to folder 1ifhysk_1',
  'Give users authenticated access to folder 1ifhysk_2',
  'Give users authenticated access to folder 1ifhysk_3',
